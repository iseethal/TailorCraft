                    ...
                    <div class="card-body">
                        ...
                        <div id="variantsSectionLeft" class="visually-hidden">
                            ...
                            <div class="form-text small mt-2">Upload images per variant — inputs named
                                <code>variant_images[INDEX][]</code>.
                            </div>
                        </div>
                                ...
                                @foreach ($variants as $variant)
                                    @if ($variant->images && $variant->images->count() > 0)
                                        @foreach ($variant->images as $img)
                                            <div class="position-relative border rounded p-2 m-2 d-flex align-items-center"
                                   ...
                                   border:1px solid #ccc;border-radius:6px;">
                                                ...
                                                <div class="ms-1">
                                                    ...
                                                    <div class="text-muted small">
                                                        {{ $variant->size->size_name ?? 'No Size' }}
                                                    </div>
                                                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="galleryInput" name="product_images[]" type="file" class="form-control"
      ...
      <button type="button" class="btn btn-sm btn-outline-danger ms-1" onclick="removeSelectedSize(this)">✕</button>
        ...
        function generateVariants() {
            ...
            if (hasColors && hasSizes) {
                colors.forEach(c => sizes.forEach(s => combos.push({
                    color: c,
                    size: s
                })));
            } else if (hasColors) {
                colors.forEach(c => combos.push({
                    color: c,
                    size: null
                }));
            } else {
                sizes.forEach(s => combos.push({
                    color: null,
                    size: s
                }));
            }
